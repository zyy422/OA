...
void CStaticEx::OnClicked()
{
    ...
    if ( !m_shellCommandArg.IsEmpty() )
    {
         ...
         //
         HINSTANCE h = ShellExecute( 0, TEXT("open"), m_shellCommandArg, 0, 0, SW_SHOWNORMAL );
         ...
         if ( (UINT)h > 32 ) {
             ...
             MessageBeep(0);
             AfxMessageBox( TEXT("Unable to open ") + m_shellCommandArg + TEXT('.'), MB_OK | MB_ICONINFORMATION );
         }
    }
