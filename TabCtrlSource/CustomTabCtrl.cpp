...
LOGFONT CCustomTabCtrl::lf_default = {18, 0, 0, 0, FW_NORMAL, 0, 0, 0,
			DEFAULT_CHARSET, OUT_CHARACTER_PRECIS, CLIP_CHARACTER_PRECIS,
			DEFAULT_QUALITY, DEFAULT_PITCH | FF_DONTCARE, TEXT("Microsoft Sans Serif")};
...
void CCustomTabCtrl::RecalcEditResized(int nOffset, int nItem)
{
	...
	do
	{
		...
		int h = pDC->DrawText(m_aItems[nItem]->m_sText+TEXT("X"), r, DT_CALCRECT);
